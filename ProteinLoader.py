...
class ProteinDataset(Dataset):
    def __init__(self, file_path, vocab_size=1000, max_length=512, mask_percentage=0.15):
        tup = process_data(file_path, vocab_size, max_length, mask_percentage)
        self.data = tup[0]
...
# Testing
# dataset = ProteinDataset("data/test.fasta", vocab_size=1000, max_length=512, mask_percentage=0.15)
