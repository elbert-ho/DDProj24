...
def objective(trial):
    ...
    total_epochs = trial.suggest_int('total_epochs', 50, 100)
    ...
    best_val_loss = train_and_validate(d_model, num_heads, num_layers, d_ff, dropout, learning_rate, batch_size, device, warmup_epochs, total_epochs, patience)
