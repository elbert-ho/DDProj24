...
for index, row in tqdm.tqdm(df.iterrows(), total=len(df)):
    ...
    if save_smiles:
        selfies_toks = (sf.encoder(smiles_string))
        ...
        smiles_full = smiles_output_here[0].flatten().cpu().detach().numpy()
    ...
    # if save_smiles:
        # del encoded_smiles, smiles_output_here
...
if save_smiles:
    # print(smiles_output)
    save_batch(smiles_output, f'data/smiles_output_selfies.npy')
